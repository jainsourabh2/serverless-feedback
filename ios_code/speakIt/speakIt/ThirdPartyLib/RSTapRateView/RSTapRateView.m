...
- (id)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    [_oneStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateNormal];
...
//    [self addSubview:_oneStarReflectionView];
    ...
    [_twoStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateNormal];
...
//    [self addSubview:_twoStarReflectionView];
    ...
    [_threeStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateNormal];
